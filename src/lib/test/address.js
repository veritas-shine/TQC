...
describe('Address', function() {
  ...
  describe('encodings', function() {
    ...
    it('should derive from this known address string livenet', function() {
      ...
      sliceString.should.equal('bd58cdb1190967afe8f7c019847680821eed1925');
    });
  ...
  describe('#toBuffer', function() {
    ...
    it('bd58cdb1190967afe8f7c019847680821eed1925 corresponds to hash Gb76WZGzhoKQRu1pzM1HQrwGdxwpnfeY68', function() {
      var address = new Address(str);
      address.toBuffer().slice(1).toString('hex').should.equal('bd58cdb1190967afe8f7c019847680821eed1925');
    });
